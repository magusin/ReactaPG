...
const LevelUpChoices = ({ player }: { player: Player | null }) => {
  ...
  return (
    ...
    >
      <Typography
       variant='h4' sx={{ margin: '12px', fontFamily: 'fantasy', textAlign: 'center' }}
      >Choisissez votre charactéristique primaire pour le level up</Typography>
      ...
      {player && player.ability1 && (
        ...
        >
          ...
          {player && player.ability1 && player.ability1.dexterityIncrease > 0 && (
            <Box
              sx={{
                display: 'flex',
                flexDirection: 'row',
          ...
          {player && player.ability1 && player.ability1.healthIncrease > 0 && (
            <Box
              sx={{
                display: 'flex',
                flexDirection: 'row',
          ...
          {player && player.ability1 && player.ability1.speedIncrease > 0 && (
            <Box
              sx={{
                display: 'flex',
                flexDirection: 'row',
      ...
      {player && player.ability2 && (
        ...
        >
          ...
          {player && player.ability2 && player.ability2.dexterityIncrease > 0 && (
            <Box
              sx={{
                display: 'flex',
                flexDirection: 'row',
          ...
          {player && player.ability2 && player.ability2.healthIncrease > 0 && (
            <Box
              sx={{
                display: 'flex',
                flexDirection: 'row',
          ...
          {player && player.ability2 && player.ability2.speedIncrease > 0 && (
            <Box
              sx={{
                display: 'flex',
                flexDirection: 'row',
      ...
      {player && player.ability3 && (
        ...
        >
          ...
          {player && player.ability3 && player.ability3.dexterityIncrease > 0 && (
            <Box
              sx={{
                display: 'flex',
                flexDirection: 'row',
          ...
          {player && player.ability3 && player.ability3.healthIncrease > 0 && (
            <Box
              sx={{
                display: 'flex',
                flexDirection: 'row',
          ...
          {player && player.ability3 && player.ability3.speedIncrease > 0 && (
            <Box
              sx={{
                display: 'flex',
                flexDirection: 'row',
